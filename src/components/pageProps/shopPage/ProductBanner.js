    ...
    <div className="w-full flex flex-col md:flex-row md:items-center justify-between">
      ...
      <div className="flex items-center gap-2 md:gap-6 mt-4 md:mt-0">
        <div className="flex items-center gap-2 text-base text-[#767676] relative">
          <label className="block">Сортировать:</label>
          <select
          ...
          >
            <option value="Best Sellers">Топ продаж</option>
            <option value="New Arrival">Для мужчин</option>
            <option value="Featured">Для женщин</option>
            <option value="Final Offer">Для похудении</option>
            <option value="Final Offer">Против алкозависимости</option>
          </select>
